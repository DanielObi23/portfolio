...
export default function VscodeNavbar() {
  return (
    <div className="col-span-12 row-span-1 flex justify-between items-center p-2 border-b-[1.5px] bg-primary border-[#1e1e1e]">
      ...
      <div className="flex gap-2 items-center">
        <div className="rounded-lg w-80 h-7 flex gap-1 items-center justify-center bg-secondary text-sm">
          <Search size={16} />
